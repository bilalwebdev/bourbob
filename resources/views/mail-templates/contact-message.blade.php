                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('images/mail-img.jpeg') }}" alt=""
                                                                            title=""
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <h4
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: arial,helvetica,sans-serif; font-size: 16px;">
                                                                Someone Filled out the contact info with the following
                                                                details
                                                            </h4>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div style="display:flex;">
                                                                    <strong>First Name: </strong> <p>{{ $first_name }}
                                                                    </p>
                                                                </div>
                                                                <div style="display:flex;">
                                                                    <strong>Last Name: </strong> <p>{{ $last_name }}
                                                                    </p>
                                                                </div>
                                                                <div style="display:flex;">
                                                                ...
                                                                <div style="display:flex;">
                                                                    <strong>Message: </strong> <p>{{ $email_message }}
                                                                    </p>
                                                                </div>
                                                            </div>
