<div>
    <div class="w-full p-4 space-y-10 bg-white rounded-lg dark:bg-gray-800">
        ...
        <form wire:submit.prevent = "save" class="p-6">
            <div class="mb-2 form-group">
                ...
                <div wire:ignore>
                    <textarea wire:model="site.privacy_policy" id="myeditorinstance" rows="20" class="w-full text-black dark:text-white form-control" ></textarea>
                </div>
            </div>
