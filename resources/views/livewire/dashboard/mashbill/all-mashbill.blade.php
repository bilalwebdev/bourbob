<div>
    ...
    @include('dashboard.mashbill.components.add-mashbill')

    <div class="grid grid-cols-12 gap-6 mt-5" wire:ignore.self>
        <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">

            {{ $mashbills->links('dashboard.components.custom-paginate') }}

            <div class="w-full mt-3 sm:w-auto sm:mt-0 sm:ml-auto md:ml-0">
                <div class="relative w-56 text-slate-500">
                    <input type="text" class="w-56 pr-10 form-control box" placeholder="Search..." wire:model.debounce.500ms="searchTerm">
                        ...
                        <tr class="intro-x" wire:ignore.self>
                            ...
                            <td class="w-56 table-report__action">
                                <div class="flex items-center justify-between">
                                    @if ($editRowId !== $mashbill->id)
                                        <button wire:click.prevent="editRow({{ $mashbill->id }})"
                                    ...
                                    <button wire:click="$emit('triggerDelete',{{ $mashbill->id }})" ƒ
    ...
    <x-entity-delete trigger="triggerDelete" message="Mashbill will be deleted!" />
