<div>
    ...
    @include('dashboard.brand.components.add-brand')

    <div class="grid grid-cols-12 gap-6 mt-5" wire:ignore.self>
        <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">

            {{ $brands->links('dashboard.components.custom-paginate') }}
                        ...
                        <tr class="intro-x" wire:ignore.self>
                            ...
                            <td class="w-56 table-report__action">
                                <div class="flex items-center justify-between">
                                    @if ($editRowId !== $brand->id)
                                        <button wire:click.prevent="editRow({{ $brand->id }})"
                                    ...
                                    <button wire:click="$emit('triggerDelete',{{ $brand->id }})" ƒ
    ...
    <x-entity-delete trigger="triggerDelete" message="Brand will be deleted!" />
