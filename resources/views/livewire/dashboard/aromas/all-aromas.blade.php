<div>
    ...
    @include('dashboard.aromas.components.add-aromas')

    <div class="grid grid-cols-12 gap-6 mt-5" wire:ignore.self>
        <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">

            {{ $aromas->links('dashboard.components.custom-paginate') }}
                        ...
                        <tr class="intro-x" wire:ignore.self>
                            ...
                            <td class="w-56 table-report__action">
                                <div class="flex items-center justify-between">
                                    @if ($editRowId !== $aroma->id)
                                        <button wire:click.prevent="editRow({{ $aroma->id }})"
                                    ...
                                    <button wire:click="$emit('triggerDelete',{{ $aroma->id }})" ƒ
    ...
    <x-entity-delete trigger="triggerDelete" message="Aroma will be deleted!" />
