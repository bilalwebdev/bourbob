<div>
    ...
    @include('dashboard.state.components.add-state')

    <div class="grid grid-cols-12 gap-6 mt-5" wire:ignore.self>
        <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">

            {{ $states->links('dashboard.components.custom-paginate') }}
                        ...
                        <tr class="intro-x" wire:ignore.self>
                            ...
                            <td class="w-56 table-report__action">
                                <div class="flex items-center justify-between">
                                    @if ($editRowId !== $state->id)
                                        <button wire:click.prevent="editRow({{ $state->id }})"
                                    ...
                                    <button wire:click="$emit('triggerDelete',{{ $state->id }})" ƒ
    ...
    <x-entity-delete trigger="triggerDelete" message="State will be deleted!" />
