<div>
    ...
    @include('dashboard.flavors.components.add-flavor')

    <div class="grid grid-cols-12 gap-6 mt-5" wire:ignore.self>
        <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">

            {{ $flavors->links('dashboard.components.custom-paginate') }}
                        ...
                        <tr class="intro-x" wire:ignore.self>
                            ...
                            <td class="w-56 table-report__action">
                                <div class="flex items-center justify-between">
                                    @if ($editRowId !== $flavor->id)
                                        <button wire:click.prevent="editRow({{ $flavor->id }})"
                                    ...
                                    <button wire:click="$emit('triggerDelete',{{ $flavor->id }})" ƒ
    ...
    <x-entity-delete trigger="triggerDelete" message="Flavor will be deleted!" />
