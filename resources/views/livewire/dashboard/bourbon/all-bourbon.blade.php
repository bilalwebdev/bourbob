<div>
    ...
    @include('dashboard.bourbon.components.add-bourbon')

    <div class="grid grid-cols-12 gap-6 mt-5" wire:ignore.self>
        <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">

            {{ $bourbons->links('dashboard.components.custom-paginate') }}
                        ...
                        <tr class=" intro-x" wire:ignore.self>
                            ...
                            <td>
                                <div class="">
                                    <div class=" form-switch">
                                      <input wire:click="featured({{ $bourbon->id }})" style="height: 21px" class="float-left h-1 align-top bg-no-repeat bg-contain rounded-full shadow-sm appearance-none cursor-pointer b-g-gray-300 form-check-input dark:bg-white focus:outline-none" type="checkbox" role="switch" {{ $bourbon->is_featured == 1 ? "checked" : "" }}>
                                    </div>
                                  </div>
                            </td>
                            ...
                            <td class="w-56 table-report__action">
                                <div class="flex items-center justify-between">
                                    <a href="{{ route('dashboard.bourbons.edit', $bourbon->slug) }}"
                                    ...
                                    <button wire:click="$emit('triggerDelete',{{ $bourbon->id }})" ƒ
    ...
    <x-entity-delete trigger="triggerDelete" message="Bourbon will be deleted!" />
